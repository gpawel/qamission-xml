...
public class LocationSelector extends org.qamission.examples.pages.Page {
    ...
    public org.qamission.examples.pages.StoreFlyer openStoreFlyer() {
        wait.until(ExpectedConditions.presenceOfElementLocated(storeFlyerSelector));
        driver.findElement(storeFlyerSelector).click();
        return new org.qamission.examples.pages.StoreFlyer(driver);
    }
