package org.qamission.examples.pages;

import org.openqa.selenium.*;
import org.openqa.selenium.support.ui.ExpectedConditions;
import org.qamission.model.Product;
import java.util.List;

public class SearchResultsPage extends org.qamission.examples.pages.Page {
    ...
    public List<Product> getAllFoundProducts() {
        ...
        org.qamission.examples.pages.ProductInfoParser parser = new org.qamission.examples.pages.ProductInfoParser(driver);
    ...
    public Product getProdcutInfoByIndex(int productNumberOnPage) {
        ...
        WebElement el = els.get(0);ProductInfoParser parser = new ProductInfoParser(driver);
